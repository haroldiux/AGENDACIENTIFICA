...
def run():
    ...
    # Clear out any random activities inserted into Medicina for 1-2026
    db.query(ScientificActivity).filter(ScientificActivity.career_id == medicina.id, ScientificActivity.gestion_id == gestion_2026.id).delete()
    db.query(AcademicActivity).filter(AcademicActivity.career_id == medicina.id, AcademicActivity.gestion_id == gestion_2026.id).delete()
    db.commit()
    ...
    activities_data = [
        ...
        {"title": "Día del Estado Plurinacional (feriado)", "start": date(2026, 2, 6), "end": date(2026, 2, 7), "color": "#FCA5A5", "cat": "Academica"}, 
        ...
        {"title": "Día del Padre", "start": date(2026, 3, 14), "end": date(2026, 3, 14), "color": "#FCA5A5", "cat": "Academica"}, 
        ...
        {"title": "Día del Trabajador", "start": date(2026, 5, 2), "end": date(2026, 5, 2), "color": "#FCA5A5", "cat": "Academica"}, 
    ...
    db.commit()
    print("Seeding completed for Medicina 1-2026!")
    db.close()
